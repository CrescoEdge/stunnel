    ...
    private void processJmsMessage(ChannelHandlerContext ctx, Message msg) {
        ...
        try {
            if (msg instanceof BytesMessage) {
                ...
                // HOP TRACE: brokers stamped the SRC->DST broker path onto cresco_hops as this arrived.
                ...
                // the old 8KB re-chunk loop cost 32x alloc+copy+write+promise per 256KB message.
